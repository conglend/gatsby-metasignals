export default [
  ...
  { inputs: [], name: 'SoftCapExceeded', type: 'error' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'lifetimeBalance', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  { inputs: [], name: 'affiliateWithdraw', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [
  ...
  { inputs: [], name: 'closeAllowlistMint', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [],
    name: 'collectionSize',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
  ...
  { inputs: [], name: 'disableAllowlistOnlyMode', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  { inputs: [], name: 'enableAllowlistOnlyMode', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
  ...
  { inputs: [], name: 'openAllowlistMint', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  { inputs: [], name: 'openMinting', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [],
    name: 'owner',
    outputs: [{ internalType: 'address', name: '', type: 'address' }],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_incrementBatch', type: 'uint256' }],
    name: 'setPriceIncrementBatch',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'uint256', name: '_incrementPercent', type: 'uint256' }],
    name: 'setPriceIncrementPercent',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  {
    inputs: [],
    name: 'softCapEnforced',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    stateMutability: 'view',
    type: 'function',
  },
  { inputs: [], name: 'stopMinting', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
  ...
  {
    inputs: [{ internalType: 'string', name: '_updatedTokenURI', type: 'string' }],
    name: 'unveil',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'bytes32', name: '_newMerkleRoot', type: 'bytes32' }],
